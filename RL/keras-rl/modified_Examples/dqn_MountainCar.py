...
class GradsCallback(Callback):
    ...
    def on_episode_end(self, episode, logs={}):
        ...
        save_data_hdf5(np.asarray(self.h_gradients_0), "ep-grads-0_"+str(self.epis), "/home/lesoleil/Desktop/ML/RL/keras-rl/soheil_logs/MountainCar_dqn_log", 'a')
        save_data_hdf5(np.asarray(self.h_gradients_1), "ep-grads-1_" + str(self.epis), "/home/lesoleil/Desktop/ML/RL/keras-rl/soheil_logs/MountainCar_dqn_log", 'a')
        save_data_hdf5(np.asarray(self.h_actions), "ep-actions_" + str(self.epis), "/home/lesoleil/Desktop/ML/RL/keras-rl/soheil_logs/MountainCar_dqn_log", 'a')
        save_data_hdf5(np.asarray(self.h_states), "ep-states_" + str(self.epis), "/home/lesoleil/Desktop/ML/RL/keras-rl/soheil_logs/MountainCar_dqn_log", 'a')
        save_data_hdf5(np.asarray(self.h_Q_values), "ep-q_values_" + str(self.epis), "/home/lesoleil/Desktop/ML/RL/keras-rl/soheil_logs/MountainCar_dqn_log", 'a')
        self.h_actions = []
        self.h_gradients_0 = []
        self.h_gradients_1 = []
        self.h_states = []
...
parser.add_argument('--nb_episodes_for_train',type=int,default=50000,help="Number of episodes to test/evaluate. Default is 50000")
...
gamma = 0.99
dqn = DQNAgent(model=model, nb_actions=nb_actions, gamma=gamma, memory=memory, nb_steps_warmup=10,
...
if args.mode == 'train':
    ...
    history = dqn.fit(env, nb_steps=args.nb_episodes_for_train, visualize=args.visualize, verbose=2)

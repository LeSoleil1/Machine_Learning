...
class GradsCallback(Callback):
    ...
    def on_episode_end(self, episode, logs={}):
        ...
        save_data_hdf5(np.asarray(self.h_gradients_0), "ep-grads-0_"+str(self.epis), "/home/lesoleil/Desktop/RL/keras-rl/soheil_logs/cartpole_duel_dqn_log", 'a')
        save_data_hdf5(np.asarray(self.h_gradients_1), "ep-grads-1_" + str(self.epis), "/home/lesoleil/Desktop/RL/keras-rl/soheil_logs/cartpole_duel_dqn_log", 'a')
        save_data_hdf5(np.asarray(self.h_actions), "ep-actions_" + str(self.epis), "/home/lesoleil/Desktop/RL/keras-rl/soheil_logs/cartpole_duel_dqn_log", 'a')
        save_data_hdf5(np.asarray(self.h_states), "ep-states_" + str(self.epis), "/home/lesoleil/Desktop/RL/keras-rl/soheil_logs/cartpole_duel_dqn_log", 'a')
        self.h_actions = []
        self.h_gradients_0 = []
        self.h_gradients_1 = []
        self.h_states = []

...
from ..core.rl import * #from ..core.rl_Cartpole import *
...
def learn_dt():
    # Parameters
    log_fname = '../cartpole_dt.log'
    model_path = '../data/model-cartpole-1/'
    max_depth = 12
    n_batch_rollouts = 10
    max_samples = 200000
    max_iters =80
    ...
    state_transformer = get_cartpole_symbolic
...
def bin_acts():
    ...
    seq_len = 10
    n_rollouts = 10
    log_fname = 'catpole_options.log'
    model_path = 'model-atari-cartpole-1/saved'

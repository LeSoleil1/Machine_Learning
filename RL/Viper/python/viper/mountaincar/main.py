...
from .dqn_Mountaincar import *
from ..core.dt import *
from ..util.log import *

def learn_dt():
    # Parameters
    log_fname = '../mountaincar_dt.log'
    model_path = '../data/model-mountaincar-1/'
    max_depth = 12
    n_batch_rollouts = 10
    max_samples = 200000
    max_iters = 80
    ...
    # Data structures
    env = get_mountaincar_env()
    teacher = DQNPolicy(env, model_path)
    student = DTPolicy(max_depth)
    state_transformer = get_mountaincar_symbolic
...
def bin_acts():
    ...
    seq_len = 10
    n_rollouts = 10
    log_fname = 'mountaincar_options.log'
    model_path = 'model-atari-mountaincar-1/saved'
